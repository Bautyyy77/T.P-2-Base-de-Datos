...
/*Procedure de las tablas PROVEEDOR, INSUMO, CONCESIONARIO, PEDIDO Y DETALLE_PEDIDO.*/
delimiter $$
...
call alta_proveedor('proveedor jorgito s.a', '4999-4444', 'electro_new@gmail.com');
call baja_proveedor(1);
call baja_proveedor(2);
call baja_proveedor(9);
